...
function shopcart_manageProductsPage()
{
    $nonce_action = "shopcart_manage_product";
    ...
    <div class="wrap adminContainer">
        <h2>Manage Products <span style="font-size:.5em;">Shopcart</span></h2>

        <?php if( $failed ) echo "<p class='failText'>$failed</p>"; ?>
        <?php if( $success ) echo "<p class='successText'>$success</p>"; ?>

        <form id="manageProductForm" method="post" action="/wp-admin/admin.php?page=shopcart_manage">
